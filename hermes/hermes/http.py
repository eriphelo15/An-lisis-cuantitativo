...
class ClienteHTTP:
    """Cliente con límite de tasa, reintentos y caché en disco.

    `ttl_segundos=None` guarda la respuesta para siempre: úsalo solo con datos que no cambian
    (días de mercado ya cerrados, páginas antiguas de filings).
    """
